...
import com.unihub.auth.accountmanagement.dto.request.StudentUserRequest;
    ...
    public UserDto createUser(BaseUserRequest userRequest, Authentication authentication) {
        ...
        user.setUniversityMetadata(
                UniversityMetadata.builder()
                        ...
                        .cid(((StudentUserRequest)userRequest).getCid())
                        .gpa(((StudentUserRequest)userRequest).getGpa())
                        .user(user)
                        .build()
        );
