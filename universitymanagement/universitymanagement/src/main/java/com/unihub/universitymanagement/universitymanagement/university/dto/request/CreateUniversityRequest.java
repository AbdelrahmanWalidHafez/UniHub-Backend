package com.unihub.universitymanagement.universitymanagement.university.dto.request;
...
public class CreateUniversityRequest {
    ...
    @NotBlank(message = "Accreditation key cannot be empty")
    @JsonProperty("accreditation_key")
    private String accreditationKey;

    @NotBlank(message = "Logo key cannot be empty")
